...
- `reparsearEquipo(raw, equipoGuardado)` - Re-parses raw pokepaste text. Returns fresh team from `parsearPoképaste`.
- `renderEquipo(equipo, urlPaste)` - Renders sprite images as links to the pokepaste URL.
